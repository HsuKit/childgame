...
- `data/questions/` 是题库唯一内容源；不要在其他位置维护重复题目。
...
- 仅当改动达到上述记录门槛时，将实际实施与验证结果写回迭代记录。
- 仅当改动达到上述记录门槛时，同步 [迭代账本](./docs/ai/iterations/README.md)。
- 仅在现状或业务域实际受影响时，更新对应现状文档和 domain 文档。
